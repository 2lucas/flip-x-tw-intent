...
let spacePressCount = 0; // Contador de pressões da tecla espaço
let urlIndex = 0; // Índice para alternar entre as URLs


const urls = [
    "https://x.com/intent/follow?screen_name=2Iucas",
    "https://x.com/intent/retweet?tweet_id=1906562897104228751",
    "https://x.com/intent/like?tweet_id=1906562897104228751"
];
...
function handleKeyDown(e) {
    ...
    if (e.code === "Space") {
        spacePressCount++; // Incrementa o contador
